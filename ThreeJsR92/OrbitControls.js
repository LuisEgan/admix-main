...
THREE.OrbitControls = function(object, domElement, scene) {
   ...
   this.update = (function() {
      ...
      return function update() {
         ...
         if (intersected[0]) {
            scope.zoomSpeed =
               intersected[0].distance <= distToChangeSpeed
                  ? scope.zoomSpeedOriginal / 5
                  : scope.zoomSpeedOriginal;
         }
   ...
   var pan = (function() {
      ...
      return function pan(deltaX, deltaY) {
         ...
         var clientHeight = Math.max(window.innerHeight, element.clientHeight);
   ...
   function handleMouseMoveRotate(event) {
      ...
      var clientHeight = Math.max(window.innerHeight, element.clientHeight);
      rotateUp(
         ((2 * Math.PI * rotateDelta.y) / clientHeight) * scope.rotateSpeed
      );
