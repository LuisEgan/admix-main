...
THREE.PointerLockControls = function (pCamera, {
      ...
      pitchObject.rotation.x = iPitchRot;
      pitchObject.add(camera);

      var yawObject = new THREE.Object3D();
      yawObject.position.x = iYawX;
      yawObject.position.y = iYawY;
      yawObject.position.z = iYawZ;
      yawObject.rotation.y = iYawRot;
      ...
      this.setRelativeRotationObj = function (pitchX, yawY) {
            // pitchObject.position.x = pitchX;
            yawObject.position.y = yawY;
      }
      ...
      this.setYawObject = function (x, y, z) {
            yawObject = new THREE.Vector3(x, y, z);
      }
      ...
      this.update = function () {
            ...
            scope.getYawObject().position.add(velocity);
            // scope.getYawObject().translateX(velocity.x * delta);
            // scope.getYawObject().translateY(velocity.y * delta);
            // scope.getYawObject().translateZ(velocity.z * delta);
