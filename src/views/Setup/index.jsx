...
export default class Setup extends Component {
  ...
  renderApps() {
    let { apps, asyncLoading, selectedApp } = this.props;

    return apps.map((app, i) => {
      // if (i > 1) return;
      const { _id, name, isActive } = app;
      const liveStatus = isActive ? "Live" : "Inactive";
      ...
      return (
        <div className={`app-select-container ${selectedAppClass}`} key={_id}>
    ...
    return (
      <div id="no-apps">
        <img
          ...
          alt="mmm"
        />
        <h3 className="st">Looks like you have not connected your app yet.</h3>
        <h2 className="mb">
          To get started, create your inventory in Unity with the <br /> Advir
          plugin. Apps will appear here automatically.
        </h2>
        <h2 className="mb">
          <br />
          <br />
  ...
  render() {
    const { appSelected, edit, allAppsIds, showFilter, filterBy } = this.state;
    console.log("filterBy: ", filterBy);
    const { selectedApp, location, apps, asyncLoading } = this.props;
      ...
      <div className="step-container" id="apps">
        <div className="container">
          <div id="apps-myApps">
            ...
            <div id="filter" className="unselectable" onClick={this.addFilter}>
