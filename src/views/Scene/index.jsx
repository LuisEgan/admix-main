...
class Scene extends Component {
  ...
  changeDropdownValue({ dropdown, save, placementId, newValue }, e) {
    ...
    _a.track(_aAction, {
      ...
      label:
        displayMode === "raw"
          ? ga.labels[
              dropdown === "category" ? "changeCategory" : "changeSubCategory"
            ].onRaw
          : ga.labels[
              dropdown === "category" ? "changeCategory" : "changeSubCategory"
            ].on3d,
  ...
  renderControls() {
    ...
    return (
      <div>
        ...
        {!showControls && displayMode === "3D" && (
          <div id="toggle-controls-on" onClick={this.toggleControlStatus}>
  ...
  renderRawDataTable() {
    ...
    savedInputs.forEach(input => {
      ...
      savedInputsByPlacementId[input.placementId].subCategory = Array.isArray(
        input.subCategory,
      )
        ? input.subCategory[0]
        : input.subCategory;
    ...
    selectedScene.placements &&
      selectedScene.placements.forEach(placement => {
        if (savedInputsByPlacementId[placement._id]) {
          ...
          subCategory = savedInputsByPlacementId[placement._id].subCategory;
        } else {
    ...
    return (
      <div className="rawDataTable-cont">
        ...
        <div className="rawDataTable">
          <ReactTable
            data={data}
            noDataText={asyncLoading ? "Loading..." : noPlacementsDataMssg}
            columns={[
              {
        ...
        <br />
        <span className="mb">
          Tip: for a better user experience, check the 'Export OBJ' option in
          the Unity plugin{" "}
  ...
  renderSceneLoadingError() {
    ...
    return (
      <div id="scene-loading-error" className="mb">
        ...
        send us an email to{" "}
        <a href="mailto:support@admix.in">support@admix.in</a> with this text:{" "}
        <br />
        <div className="code">
          <code>
            Scene not loaded -. <br />
