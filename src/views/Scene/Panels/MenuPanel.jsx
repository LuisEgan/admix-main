...
import { getPlacements, resetSelectedApp } from "actions/app";
...
export default class MenuPanel extends Component {
  ...
  renderScenesSelect() {
    const { apps, asyncLoading, loadScene, selectedApp } = this.props;
    ...
    return (
      ...
      >
        ...
        >
          ...
          {saveClicked && (
            <NavLink exact to={routeCodes.VALIDATION} className="btn btn-dark">
              Finish Editing
            </NavLink>
          )}
