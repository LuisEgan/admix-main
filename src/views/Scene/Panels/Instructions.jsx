...
export default class Instructions extends Component {
   ...
   render() {
      ...
      return (
         <div className={`container ${slideAnim}`} id="instructions-panel">
            <div className="container">
               ...
               <ul className="list-group list-group-flush">
                  <li className="list-group-item">
                     1. Select your &nbsp;<strong>scene</strong>.
                  </li>
                  <li className="list-group-item">
                     2. Select your &nbsp;<strong>placement</strong>{" "}
                     &nbsp;objects.
                  </li>
                  <li className="list-group-item">
                     3. Fill the form for each &nbsp;<strong>placement</strong>{" "}
                     &nbsp;object.
                  </li>
                  <li className="list-group-item">
                     4. Once you are done, click on the finish button.
                  </li>
               </ul>
               ...
               <div className="cc">
                  <h3>Scene navigation controls</h3>
               </div>
               <div className="cc">
                  MOVE mouse & press LEFT/A: rotate, MIDDLE/S: zoom, RIGHT/D:
                  pan
               </div>
            </div>
